...
import dao.IPeriodicalCategory;
...
public class PeriodicalCategoryDAO extends AbstractDAO implements IPeriodicalCategory {
    ...
    private static PeriodicalCategoryDAO periodicalCategoryDAO = null;
    ...
    public static PeriodicalCategoryDAO getInstance() {
        if (periodicalCategoryDAO == null) {
            return new PeriodicalCategoryDAO();
        }
        ...
        /*try (Connection connection = daoFactory.getConnection();
            ...
            try (ResultSet resultSet = statement.executeQuery()) {
                while (resultSet.next()) {
                    category = new PeriodicalCategory(resultSet.getInt("id"),
